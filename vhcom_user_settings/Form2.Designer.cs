namespace VHCom_users {
	partial class WindowsFormUser {
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WindowsFormUser));
			...
			this.chk_grpadmin = new System.Windows.Forms.CheckBox();
			this.chk_grprdp = new System.Windows.Forms.CheckBox();
			this.chk_grpusers = new System.Windows.Forms.CheckBox();
			...
			this.label2.Text = "Új felhasználónév";
			...
			this.label4.Text = "Rendszergazdák";
			...
			this.label5.Text = "Távoli felhasználó";
			...
			// chk_grpusers
			// 
			this.chk_grpusers.AutoSize = true;
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.chk_grpadmin);
			...
			this.groupBox2.Text = "Csoportbeállítások";
			// 
			// groupBox3
			// 
		...
		public System.Windows.Forms.CheckBox chk_grpadmin;
		public System.Windows.Forms.CheckBox chk_grprdp;
		public System.Windows.Forms.CheckBox chk_grpusers;
		public System.Windows.Forms.CheckBox chk_enabled;
